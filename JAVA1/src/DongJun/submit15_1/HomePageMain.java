...
import DongJun.submit15_1.service.HomepageService;
import DongJun.submit15_1.service.MemberService;
				...
				if(pw.equals(login.getMemPw())) {
					...
					while(true) {
						...
						if(select == 1) {
							...
							HomepageVO temp = new HomepageVO(title, content, login.getMemId(), date);
